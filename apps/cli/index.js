...
const COMMANDS = {
    ...
    payout, payments, gpu, firewall, chat, setup, model, tui, doctor, service, help
};

// Commands that can run without a loaded config.
const NO_CONFIG = new Set(['init', 'login', 'help', 'stats', 'logs', 'stop', 'gpu', 'firewall', 'chat', 'setup', 'model', 'tui', 'doctor', 'service']);
