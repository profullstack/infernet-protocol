...
export const CATALOG = [
    ...
    { id: "tinyllama",        name: "TinyLlama 1.1B",          paramsB: 1.1, vramMin: 0,  ramMin: 4,  pull: "tinyllama",                              backend: "ollama", quality: 2, useCases: ["chat", "testing"] },
    { id: "llama3.2-1b",      name: "Llama 3.2 1B",            paramsB: 1,   vramMin: 0,  ramMin: 4,  pull: "llama3.2:1b",                            backend: "ollama", quality: 4, useCases: ["chat"] },
    { id: "qwen2.5-1.5b",     name: "Qwen2.5 1.5B",            paramsB: 1.5, vramMin: 0,  ramMin: 4,  pull: "qwen2.5:1.5b",                           backend: "ollama", quality: 5, useCases: ["chat", "study"] },
    // ── light ──
    ...
    { id: "qwen2.5-3b",       name: "Qwen2.5 3B",              paramsB: 3,   vramMin: 2,  ramMin: 8,  pull: "qwen2.5:3b",                             backend: "ollama", quality: 6, useCases: ["chat", "study"] },
    { id: "phi4-mini",        name: "Phi-4 Mini 3.8B",         paramsB: 3.8, vramMin: 4,  ramMin: 8,  pull: "phi4-mini",                              backend: "ollama", quality: 8, useCases: ["chat", "study", "agents", "coding"] },
    ...
    // ── 7-8B ──
    { id: "qwen2.5-7b",       name: "Qwen2.5 7B",              paramsB: 7,   vramMin: 6,  ramMin: 16, pull: "qwen2.5:7b",                             backend: "ollama", quality: 8, useCases: ["chat", "study", "coding", "agents"] },
    ...
    { id: "qwen2.5-coder-7b", name: "Qwen2.5 Coder 7B",        paramsB: 7,   vramMin: 6,  ramMin: 16, pull: "qwen2.5-coder:7b",                       backend: "ollama", quality: 9, useCases: ["coding", "agents"] },
    { id: "dolphin3-8b",      name: "Dolphin 3 8B (uncensored)", paramsB: 8, vramMin: 6,  ramMin: 16, pull: "dolphin3:8b",                            backend: "ollama", quality: 8, useCases: ["chat", "uncensored"], uncensored: true },
    { id: "deepseek-r1-7b",   name: "DeepSeek-R1 7B",          paramsB: 7,   vramMin: 6,  ramMin: 16, pull: "deepseek-r1:7b",                         backend: "ollama", quality: 8, useCases: ["study", "coding", "research", "agents"] },
